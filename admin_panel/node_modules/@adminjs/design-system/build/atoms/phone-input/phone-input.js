import ReactPhoneInputLib from 'react-phone-input-2';
...
const ReactPhoneInput = ReactPhoneInputLib.default ?? ReactPhoneInputLib;
 ...
 */
const PhoneInput = styled(ReactPhoneInputComponent)`
  ${PhoneInputStyles}
  width: 100%;
  position: relative;
  & > input {
